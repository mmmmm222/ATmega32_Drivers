...
/* Choose 0 => for floating if direction is input OR for low if direction is output*/
/* Choose 1 => for pullup if direction is input OR for HIGH if direction is output*/
